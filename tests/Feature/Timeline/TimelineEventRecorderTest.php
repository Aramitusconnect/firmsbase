...
class TimelineEventRecorderTest extends TestCase
{
    ...
    public function test_record_writes_event_with_subject_and_actor(): void
    {
        ...
        $event = $this->recorder->record($firm, 'matter_opened', $matter, $actor, ['note' => 'test']);
    ...
    public function test_record_allows_no_subject_and_no_actor(): void
    {
        ...
        $event = $this->recorder->record($firm, 'system_event');
    ...
    {
        $firm = Firm::factory()->create();
        $event = $this->recorder->record($firm, 'test_event');
    ...
    public function test_event_type_accepts_arbitrary_future_phase_strings(): void
    {
        ...
        $event = $this->recorder->record($firm, 'invoice_created_by_a_future_phase');

        $this->assertSame('invoice_created_by_a_future_phase', $event->fresh()->event_type);
    }
    ...
    public function test_recorded_event_receives_a_public_uuidv7(): void
    {
        ...
        $event = $this->recorder->record($firm, 'matter_opened');
