...
/**
 * PaymentRefundsForceRlsActivationTest — proves the FirmsVault Pay Gate A2
 * table `payment_refunds` carries permanent FORCE ROW LEVEL SECURITY and behaves
 ...
 */
class PaymentRefundsForceRlsActivationTest extends TestCase
{
    use BuildsPayFixtures, RefreshDatabase;

    private const TABLE = 'payment_refunds';

    public function test_payment_refunds_has_permanent_force_row_level_security_enabled(): void
    {
        $row = DB::selectOne(
    ...
    public function test_payment_refunds_policy_constrains_both_reads_and_writes(): void
    {
        $policy = DB::selectOne(
    ...
    public function test_missing_tenant_context_cannot_read_payment_refunds(): void
    {
    ...
    public function test_firm_a_context_cannot_read_firm_b_payment_refunds(): void
    {
