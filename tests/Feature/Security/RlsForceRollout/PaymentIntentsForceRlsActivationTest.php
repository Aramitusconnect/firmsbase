...
/**
 * PaymentIntentsForceRlsActivationTest — proves the FirmsVault Pay Gate A2
 * table `payment_intents` carries permanent FORCE ROW LEVEL SECURITY and behaves
 ...
 */
class PaymentIntentsForceRlsActivationTest extends TestCase
{
    use BuildsPayFixtures, RefreshDatabase;

    private const TABLE = 'payment_intents';

    public function test_payment_intents_has_permanent_force_row_level_security_enabled(): void
    {
        $row = DB::selectOne(
    ...
    public function test_payment_intents_policy_constrains_both_reads_and_writes(): void
    {
        $policy = DB::selectOne(
    ...
    public function test_missing_tenant_context_cannot_read_payment_intents(): void
    {
    ...
    public function test_firm_a_context_cannot_read_firm_b_payment_intents(): void
    {
