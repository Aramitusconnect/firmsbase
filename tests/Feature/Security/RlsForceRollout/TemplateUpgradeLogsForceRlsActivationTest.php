...
class TemplateUpgradeLogsForceRlsActivationTest extends TestCase
{
    ...
    public function test_exactly_twenty_five_prepared_tables_are_force_row_level_security_enabled(): void
    {
        ...
        $expectedForced = array_merge(self::PREVIOUSLY_FORCED_TABLES, ['template_upgrade_logs']);
        ...
        $this->assertSame(25, count($actuallyForced), 'Exactly twenty-five prepared tables must be FORCE RLS enabled after this batch — no more, no less.');
