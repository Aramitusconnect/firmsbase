...
class PilotFeedbackItemsForceRlsActivationTest extends TestCase
{
    ...
    public function test_exactly_fifty_prepared_tables_are_force_row_level_security_enabled(): void
    {
        ...
        $expectedForced = array_merge(self::PREVIOUSLY_FORCED_TABLES, ['pilot_feedback_items']);
        ...
        $this->assertSame(50, count($actuallyForced), 'Exactly fifty prepared tables must be FORCE RLS enabled after Section 39A-3L, Checkpoint 32 — no more, no less.');
    ...
    {
        $coverage = new RowLevelSecurityCoverageMappingService();
        $forced = array_merge(self::PREVIOUSLY_FORCED_TABLES, ['pilot_feedback_items']);
