...
class SecurityEventsForceRlsActivationTest extends TestCase
{
    ...
    public function test_exactly_fifty_two_prepared_tables_are_force_row_level_security_enabled(): void
    {
        ...
        $this->assertSame(157, count($actuallyForced), 'Exactly fifty-two prepared tables must be FORCE RLS enabled after Section 39A-3L, Phase B6, Checkpoint 34 — no more, no less.');
