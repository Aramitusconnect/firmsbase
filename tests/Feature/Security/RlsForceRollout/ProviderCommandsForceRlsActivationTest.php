...
/**
 * ProviderCommandsForceRlsActivationTest — proves the FirmsVault Pay Gate A2
 * table `provider_commands` carries permanent FORCE ROW LEVEL SECURITY and behaves
 ...
 */
class ProviderCommandsForceRlsActivationTest extends TestCase
{
    use BuildsPayFixtures, RefreshDatabase;

    private const TABLE = 'provider_commands';

    public function test_provider_commands_has_permanent_force_row_level_security_enabled(): void
    {
        $row = DB::selectOne(
    ...
    public function test_provider_commands_policy_constrains_both_reads_and_writes(): void
    {
        $policy = DB::selectOne(
    ...
    public function test_missing_tenant_context_cannot_read_provider_commands(): void
    {
    ...
    public function test_firm_a_context_cannot_read_firm_b_provider_commands(): void
    {
