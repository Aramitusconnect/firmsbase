...
class SeedDataAuditFirewallTest extends TestCase
{
    ...
    public function test_only_the_expected_files_were_modified_or_created(): void
    {
        ...
        $allowedExactFiles = [
            ...
            'config/mail.php',
            'config/services.php',
            // Round 3 audit remediation (a later, distinct, independent
            // security/architecture review requiring exact firm
            // correlation for tenant-owned email with no platform-level
            // or uncorrelated fallback) legitimately added
            // CorrelatedPasswordResetSenderService and documented its
            // required HMAC-key env var.
