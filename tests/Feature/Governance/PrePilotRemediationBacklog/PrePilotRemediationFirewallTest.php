...
class PrePilotRemediationFirewallTest extends TestCase
{
    ...
    private const PROTECTED_FILES = [
        ...
        // later, entirely distinct mission from Section 38) found a
    ...
    private function changedOrUntrackedPaths(string $scope): array
    {
        ...
        $section39bAllowed = [
            ...
            // Section 39A-3I's own factory/test files not already
            // covered by the 39A-3A batch's ConflictCheckService.php
            // entry above.
