...
class AcceptanceTestMatrixFirewallTest extends TestCase
{
    ...
    public function test_no_payment_trust_ai_email_sms_or_provider_behavior_files_were_modified(): void
    {
        ...
        $touched = array_values(array_filter(
            ...
            function (string $path) use ($behaviorFilePatterns) {
                ...
                // harness-safety branch) legitimately fixed a missing-
    ...
    private function changedOrUntrackedPaths(string $scope): array
    {
        ...
        $section39bAllowed = [
            ...
            // DeploymentHealthEnvelopeService, and AccessReviewService,
            ...
            // entirely distinct mission from Section 36) legitimately
            // added: a new no-RLS provider-health summary table +
            // model + sole-writer service + per-provider refresh job +
            ...
            // PlatformFirmIntegrationBoundedAccessService (both already
            // allowed under app/Services/ except ProviderConnectionService,
            // which lives under app/Integrations/Services/); a new
