...
class RowLevelSecurityCoverageMappingServiceTest extends TestCase
{
    ...
    public function test_exact_registry_counts_reconcile(): void
    {
        ...
        $this->assertCount(176, $this->service->preparedTables());
        ...
        // added two more DirectTenant tables (marketplace_intakes,
        // marketplace_intake_events) — 167 -> 169.
        $this->assertCount(176, $this->service->tenantOwnedTables());
    ...
    public function test_full_table_inventory_classification_counts_reconcile_to_208(): void
    {
        ...
        // added two more DirectTenant tables (marketplace_intakes,
        // marketplace_intake_events) — 167 -> 169.
        $this->assertSame(176, $summary[TenantOwnershipClassification::DirectTenant->value]);
        ...
        $this->assertSame(311, array_sum($summary));
    }
