 ...
 *
 * @extends Factory<PaymentIntentAllocation>
 */
class PaymentIntentAllocationFactory extends Factory
{
    protected $model = PaymentIntentAllocation::class;
    ...
    public function definition(): array
    {
        return [
            ...
            'destination_class' => PaymentDestinationClass::Operating,
