...
class TrustTransferRequestFactory extends Factory
{
    ...
    /**
     * trust_transfer_requests has permanent FORCE ROW LEVEL SECURITY
     * (see database/migrations/2026_08_30_980010_prepare_row_level_
     * security_and_force_rls_on_trust_transfer_requests_table.php), so
