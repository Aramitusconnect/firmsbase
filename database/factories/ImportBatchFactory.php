...
class ImportBatchFactory extends Factory
{
    ...
    /**
     * import_batches has permanent FORCE ROW LEVEL SECURITY (see
     * database/migrations/2026_08_29_970003_prepare_row_level_security_
     * and_force_rls_on_import_batches_table.php), so every INSERT (test
