...
/**
 * RequeueOutboxEventAsSupportAction — Checkpoint 11 (frozen-design-
 * post-security-review.md §3, §7, §12). Row action on the combined
 ...
 * RequeueOutboxEventAction's shape (Checkpoint 10) but routed
 * exclusively through PlatformFirmIntegrationBoundedAccessService::
 * requeueOutboxEvent() — never calls
 * App\Integrations\Services\IntegrationOutboxEventService directly.
 *
 * TOCTOU discipline (frozen design §10, mirrored from Checkpoint 10):
 * the array record's own cached fields are never used to decide
 ...
 */
class RequeueOutboxEventAsSupportAction extends Action
{
    public static function getDefaultName(): ?string
    {
        return 'requeueOutboxEventAsSupport';
    }
