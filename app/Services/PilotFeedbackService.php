...
class PilotFeedbackService
{
    public function submit(
        ...
        if ($firm !== null && $client !== null && $client->firm_id !== $firm->id) {
            throw new \RuntimeException('Client does not belong to the same firm as the pilot feedback item.');
        }

        if ($firm !== null && $matter !== null && $matter->firm_id !== $firm->id) {
            throw new \RuntimeException('Matter does not belong to the same firm as the pilot feedback item.');
        }
