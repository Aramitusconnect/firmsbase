    ...
    public function saas(): array
    {
        ...
        return [
            new GovernanceMappingResult(
                ...
                notes: "BelongsToTenant enforces isolation at the application/query layer for every SaaS firm. Database-level RLS enforcement (FORCE ROW LEVEL SECURITY, SET LOCAL app.current_firm_id) is now genuinely ACTIVE for every originally-inventoried tenant-owned table — Section 39A-5's 60-table rollout closed the last remaining uncovered tables in Wave 11 ({$uncoveredCount} tenant-owned tables now uncovered, down from 61 at the start of that rollout). Still PartiallyImplemented, not Implemented, for reasons unrelated to table coverage: (1) offboarding_exports remains an open, uncertain-ownership investigation (Wave 1F, not yet resolved, not counted in the 61/0 above); (2) the cross-firm-pivot-mismatch remediation task registered for matter_parties/matter_assignments/task_dependencies/matters/invoices/payments is still unimplemented (RLS on the parent tables alone is explicitly not accepted as sufficient for this risk); (3) the firms root-tenant-table policy is still a registered design only, not implemented; (4) the support-access policy shape for support_access_requests/support_access_sessions is still a registered design only, not implemented. See docs/governance/rls-gap-registry.md for the authoritative, current list of what remains open.",
            ),
            new GovernanceMappingResult(
                item_key: 'saas_plan_license_controls',
                item_label: 'SaaS plan and license controls',
                owning_class: EntitlementService::class,
            ...
            new GovernanceMappingResult(
                ...
                owning_class: UsageRollupService::class,
                status: GovernanceMappingStatus::Implemented,
            ...
            new GovernanceMappingResult(
                ...
                owning_class: SupportAccessPolicyService::class,
                status: GovernanceMappingStatus::PartiallyImplemented,
    ...
    public function dedicated(): array
    {
        return [
            new GovernanceMappingResult(
                ...
                owning_class: LicenseFileValidationService::class,
                status: GovernanceMappingStatus::Implemented,
            ...
            new GovernanceMappingResult(
                ...
                owning_class: FleetMigrationOrchestrationService::class,
                status: GovernanceMappingStatus::Implemented,
            ...
            new GovernanceMappingResult(
                ...
                owning_class: VersionSkewPolicyService::class,
                status: GovernanceMappingStatus::Implemented,
            ...
            new GovernanceMappingResult(
                ...
                owning_class: DeploymentHealthEnvelopeService::class,
                status: GovernanceMappingStatus::Implemented,
            ...
            new GovernanceMappingResult(
                ...
                owning_class: DedicatedCustomerTypeApprovalService::class,
                status: GovernanceMappingStatus::Implemented,
            ...
            new GovernanceMappingResult(
                ...
                owning_class: PrivateEnterpriseSettings::class,
                status: GovernanceMappingStatus::Implemented,
    ...
    public function privateEnterprise(): array
    {
        return [
            ...
            new GovernanceMappingResult(
                ...
                owning_class: RetentionPolicyService::class,
                status: GovernanceMappingStatus::Implemented,
            ...
            new GovernanceMappingResult(
                ...
                owning_class: VendorRegisterService::class,
                status: GovernanceMappingStatus::Implemented,
